...
class OfferStores {
  ...
  OfferStores.fromJson(Map<String, dynamic> json) {
    ...
    broadcastSharingImage=json['broadcastSharingImage'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['broadcastSharingImage'] = this.broadcastSharingImage;
    return data;
  }
}
